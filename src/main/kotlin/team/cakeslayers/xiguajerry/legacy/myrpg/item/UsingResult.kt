...
package team.cakeslayers.xiguajerry.legacy.myrpg.item

enum class UsingResult(result: String) {
    SUCCESS("Used the item successfully!"),
    FAILED("Failed to use the item")
}