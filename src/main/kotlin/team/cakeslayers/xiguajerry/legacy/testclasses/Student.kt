...
package team.cakeslayers.xiguajerry.legacy.testclasses

class Student() {
    fun doCalc(number: Int): Int = 1 + number

    fun doCalcPrivate(number: Int) = 2 + number

    fun doCalcPrivate2(number: Int) = 3 + number
}