...
package team.cakeslayers.xiguajerry.utils.lambda

object LambdaExampleKt {
    @JvmStatic
    fun main(args: Array<String>) {
        @Suppress("unused_parameter") val lambda1 = object : Lambda1<Int, Int> {
            override fun invoke(param1: Int): Int {
                return param1 + 1
            }
        }
    }
